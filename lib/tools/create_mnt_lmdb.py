...
if __name__ == "__main__":
  ...
  data_dir = '/media/yuming/jinheng/yanghui_code/datasets/mnt/ramdisk/max/90kDICT32px'
  lmdb_output_path = '/media/yuming/jinheng/yanghui_code/datasets/mnv_lmdb'
  train_file = os.path.join(data_dir, 'annotation_train.txt')
  val_file = os.path.join(data_dir, 'annotation_val.txt')
  test_file = os.path.join(data_dir, 'annotation_test.txt')
  image_dir = data_dir
  lines = []
