...
parser.add_argument('--synthetic_train_data_dir', nargs='+', type=str, metavar='PATH',
                    default=['/home/yuming/yanghui/datasets/lmdb_data/train_lmdb/mnt_lmdb',
                             '/home/yuming/yanghui/datasets/lmdb_data/train_lmdb/CVPR2016'])
...
parser.add_argument('--test_data_dir', type=str, metavar='PATH',
                    default='/home/yuming/yanghui/datasets/lmdb_data/test_lmdb/SVT')
...
parser.add_argument('--STN_ON', action='store_true', default=True,
...
## lstm
parser.add_argument('--with_lstm', action='store_true', default=True,
                    help='whether append lstm after cnn in the encoder part.')
parser.add_argument('--decoder_sdim', type=int, default=1024,
                    help="the dim of hidden layer in decoder.")
parser.add_argument('--attDim', type=int, default=1024,
...
parser.add_argument('--real_logs_dir', type=str, metavar='PATH',
                    default='/home/yuming/yanghui/aster.pytorch/')
