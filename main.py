...
def get_data(data_dir, voc_type, max_len, num_samples, height, width, batch_size, workers, is_train, keep_ratio):
  ...
  if is_train:
    data_loader = DataLoader(dataset, batch_size=batch_size, num_workers=workers,
      ...
      collate_fn=AlignCollate(imgH=height, imgW=width, keep_ratio=keep_ratio, is_train=True))
  else:
    data_loader = DataLoader(dataset, batch_size=batch_size, num_workers=workers,
      shuffle=False, pin_memory=True, drop_last=False,
      collate_fn=AlignCollate(imgH=height, imgW=width, keep_ratio=keep_ratio, is_train=False))
...
def main(args):
  ...
  for epoch in range(start_epoch, args.epochs):
    ...
    best_loss = trainer.train(epoch, train_loader, optimizer, current_lr,
